...
def extract_random_entries(input_file='health_sciences_papers.json', 
                          output_file='random_papers.json', num_papers=1000):
    """
    Extract random entries from the health science dataset
...
if __name__ == "__main__":
    print("Health Science Dataset - Random Entries Extractor")
    print("=" * 60)
